...
LOGGER = logging.getLogger("technology_hardware_portfolio_backtest_validator")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Stage 9 technology hardware portfolio backtest outputs.")
...
def main() -> int:
    ...
    if summary_rows:
        ...
        production_model = str(cfg_get(config, f"{CONFIG_KEY}.production_model_name", "stage7_current_production_v1"))
