...
def build_steps(
    *,
    ...
    return [
        ...
        Step("10c_financial_lineage_shadow", "stage_10_shadow", "Build candidate-only financial-lineage shadow report", py_script("technology/scripts/10c_build_technology_financial_lineage_shadow.py"), ["--family", "technology_hardware", *asof_args], blocking=False),
