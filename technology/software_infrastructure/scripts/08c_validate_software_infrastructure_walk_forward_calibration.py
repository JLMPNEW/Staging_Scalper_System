...
from technology.software_infrastructure.optuna_calibration import (  # noqa: E402
    validate_software_infrastructure_walk_forward_calibration,
)
...
if __name__ == "__main__":
    native_status = validate_software_infrastructure_walk_forward_calibration()
    hardened_status = validate_walk_forward_from_argv("software_infrastructure")
