...
def build_steps(
    *,
    ...
    return [
        ...
        Step("09_import_positioning", "stage_5", "Import positioning into technology.sqlite", py_script("technology/software_infrastructure/scripts/09_import_software_infrastructure_positioning.py"), [*asof_args, *positioning_import_args]),
        ...
        Step("10d_build_rollback_shadow", "stage_7", "Build frozen v1 rollback shadow scores", py_script("technology/software_infrastructure/scripts/10d_build_software_infrastructure_rollback_shadow_scores.py"), asof_args),
        Step("10d_validate_rollback_shadow", "stage_7", "Validate frozen v1 rollback shadow scores", py_script("technology/software_infrastructure/scripts/10d_validate_software_infrastructure_rollback_shadow_scores.py"), asof_args),
        Step("22_run_promotion_probation", "promotion_probation", "Evaluate software v2 against the v1 rollback shadow", py_script("technology/software_infrastructure/scripts/22_run_software_infrastructure_promotion_probation.py"), asof_args),
        Step("22_validate_promotion_probation", "promotion_probation", "Validate software promotion probation state", py_script("technology/software_infrastructure/scripts/22_validate_software_infrastructure_promotion_probation.py"), pass_db=False),
