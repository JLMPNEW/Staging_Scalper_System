    ...
    *,
    ...
    for item in universe:
        ...
        row: dict[str, Any] = {
            ...
            "financial_source_accession": financial["accession_number"] if financial is not None else "",
            "financial_source_fiscal_period_end": (
                financial["fiscal_period_end"] if financial is not None else ""
            ),
            "financial_source_feature_updated_at": financial["updated_at"] if financial is not None else "",
