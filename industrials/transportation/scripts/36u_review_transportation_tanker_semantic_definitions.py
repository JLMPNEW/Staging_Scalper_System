...
from industrials.transportation.tanker_semantic_review import (  # noqa: E402
...
QUEUE_NAME = "transportation_tanker_semantic_review_queue.csv"
FACT_NAME = "transportation_tanker_fact_store_ratio_candidates.csv"
DEFINITION_FIELDS = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Review selected tanker semantic definitions once.")
    parser.add_argument("--config", type=Path, default=DEFAULT_CONFIG)
    parser.add_argument("--db", type=Path, default=None)
    parser.add_argument("--asof", required=True)
    parser.add_argument("--run-id", type=int, required=True)
    parser.add_argument("--reviewed-at", required=True)
    parser.add_argument("--reviewed-by", default="transportation_tanker_semantic_policy_v1")
    parser.add_argument(
        "--priorities",
        default="HIGH",
...
def main() -> int:
    ...
    decisions_path = output_dir / "transportation_tanker_semantic_definition_decisions.csv"
    rows_path = output_dir / "transportation_tanker_semantic_candidate_reviews.csv"
    ...
    summary: dict[str, Any] = {
        ...
        "fact_store_candidates_sha256": file_sha256(fact_path) if fact_path.is_file() else "",
    ...
    write_text_atomic(
        output_dir / "transportation_tanker_semantic_review.json",
