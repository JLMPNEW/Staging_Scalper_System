#!/usr/bin/env python3
"""Capture one evaluator-compatible canonical v8 Transportation signal."""
...
from industrials.transportation.future_oos_capture_v3 import capture_signal  # noqa: E402
...
def main() -> int:
    block_legacy_route("45e_capture_transportation_future_oos")
