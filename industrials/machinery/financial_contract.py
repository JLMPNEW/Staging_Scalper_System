...
METRIC_OPERANDS: dict[str, tuple[str, ...]] = {
    ...
    "backlog_yoy_growth": ("funded_backlog", "prior_comparable_funded_backlog"),
    "backlog_to_revenue": ("funded_backlog", "revenue_ttm"),
    "reported_backlog_yoy_growth": ("reported_backlog", "prior_comparable_reported_backlog"),
    "reported_backlog_to_revenue": ("reported_backlog", "revenue_ttm"),
    "rpo_yoy_growth": ("remaining_performance_obligation", "prior_comparable_rpo"),
    ...
    "inventory_sales_growth_spread": ("inventory_growth", "revenue_yoy_growth"),
    "cash_conversion_cycle_change": ("cash_conversion_cycle", "prior_cash_conversion_cycle"),
    ...
    "capital_raise_dependence": ("equity_issuance_ttm", "debt_issuance_ttm", "cash_burn_ttm"),
    "diluted_shares_yoy_growth": ("diluted_shares", "prior_comparable_diluted_shares"),
}
