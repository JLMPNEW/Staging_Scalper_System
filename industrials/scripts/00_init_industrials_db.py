...
from industrials.core.db import connect, finish_run, init_db, start_run, table_names  # noqa: E402
from industrials.core.logging_utils import configure_utc_logging  # noqa: E402
from industrials.core.source_registry import load_source_registry, upsert_source_registry  # noqa: E402


LOGGER = logging.getLogger("init_industrials_db")
DEFAULT_CONFIG = PACKAGE_ROOT / "config.yaml"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Initialize the shared industrials SQLite database.")
...
def main() -> int:
    ...
    with connect(db_path, timeout_sec=timeout_sec) as conn:
        init_db(conn)
        run_id = start_run(conn, run_type="init_industrials_db", input_path=config_path)
        try:
            source_count = 0
            ...
            LOGGER.info("Initialized industrials DB: %s", db_path)
