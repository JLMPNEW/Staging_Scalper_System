#!/usr/bin/env python3
# ruff: noqa: E402
"""Hydrate and seal governed Consumer Defensive 8-K/6-K documents."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--maximum-documents-per-filing', type=int)
...
def main() -> int:
    ...
    with connect(
        ...
        run_id = start_run(
            conn,
            run_type='consumer_defensive_stage6b_event_document_snapshot',
        ...
        try:
            with cache_only_environment(args.cache_only):
                result = hydrate_event_document_snapshot(
                    conn,
                    bundle,
                    as_of=args.as_of,
                    ...
                    maximum_documents_per_filing=(
                        args.maximum_documents_per_filing
                    ),
            ...
            write_json(
                output_dir / 'consumer_defensive_event_document_snapshot.json',
                result,
            )
            finish_run(
                conn,
