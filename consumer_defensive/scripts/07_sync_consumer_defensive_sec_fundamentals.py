#!/usr/bin/env python3
"""Load SEC submissions, acceptance-dated Companyfacts, and filing documents."""
...
from consumer_defensive.core.stage4 import apply_applicability, bootstrap_stage4, sync_sec_fundamentals
...
def main() -> int:
    ...
    with connect(db_path, timeout_sec=timeout) as conn:
        ...
        run_id = start_run(
            conn,
            run_type="consumer_defensive_stage4_sec",
        ...
        try:
            ...
            finish_run(
                ...
                row_count=int(result["raw_facts"]),
    ...
    report_path = output_dir / "sec_fundamentals_sync.json"
