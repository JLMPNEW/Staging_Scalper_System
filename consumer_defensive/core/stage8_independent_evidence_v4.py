...
STAGE8_INDEPENDENT_EVIDENCE_V4 = (
    'consumer_defensive_stage8_independent_evidence_v4'
)


def absolute_baseline_independent_evidence_v4(
    ...
    *,
    ...
    evaluation = evaluate_candidate_same_sample_v4(
        rows,
    ...
    return {
        ...
        **independent,
        'schema_version': STAGE8_INDEPENDENT_EVIDENCE_V4,
        'validation_kind': (
            'absolute_frozen_baseline_calendar_independent_efficacy_v4'
        ),
    }


def independent_evidence_gate_v4(
