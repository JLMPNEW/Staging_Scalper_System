...
The Stage 6A foundation audit now passes and records `proceed_stage6a`; its earliest potential common-feature date is `2026-05-28`. Stage 5 remains at `2026-08-11` because the latest retained FINRA settlement for FDP at the `2026-08-14` cutoff is 48 days old, beyond the configured 45-day PIT age limit. The gate was not weakened: the newer unavailable FINRA source dates remain an explicit upstream gap.

The rollout retained pristine pre-change backups with SHA-256 `4a4eb865cea59eb9afdbaca5e236a4e2eee132445d6ad5f2567d9d009b70b822` for Consumer Defensive and `2a9f28516f7ed345419b799bed848133ce0c7a83f8d91dd54c6f6d4fe51bc35d` for the neutral positioning store. Production and backups pass SQLite integrity checks with zero foreign-key violations. The post-deployment Consumer Defensive/shared-parser suite passes 419 tests with 6 platform-specific skips; Ruff, compile, and scoped diff checks pass.

The remaining binding order is:

1. implement the stable Stage 6A common scoring-feature contract;
2. implement the Consumer Defensive Stage 6B metric adapter, complete historical filing/document inventory, shadow reconciliation, and golden-corpus validation;
