...
DAILY_SCORES_OPTIONAL_COLUMNS = {
    ...
    "research_calibration_input_eligible_flag": "REAL",
    "research_calibration_status": "TEXT",
    "research_calibration_reason": "TEXT",
    "calibration_sample_role": "TEXT",
    "oos_score_valid_flag": "REAL",
    "stage11_calibration_input_eligible_flag": "REAL",
    "stage11_calibration_input_reason": "TEXT",
    "stage11_calibration_panel_source": "TEXT",
    "survivorship_corrected_panel_flag": "REAL",
    ...
    "biotech_selection_reliability_class": "TEXT",
    "biotech_active_sleeve_weight": "REAL",
    "biotech_xbi_residual_weight": "REAL",
    "biotech_max_name_weight_within_cohort": "REAL",
    "biotech_selected_name_count_within_cohort": "REAL",
    "biotech_calibration_cohort_valid_from": "TEXT",
    "biotech_calibration_cohort_valid_to": "TEXT",
    "biotech_current_backcast_cohort": "TEXT",
    "biotech_cohort_assignment_mode": "TEXT",
    "biotech_promotion_contract_id": "TEXT",
    "biotech_promotion_contract_sha256": "TEXT",
    ...
    "ctgov_forward_catalyst_guardrail_pass": "REAL",
    "short_interest_shares": "REAL",
    "float_shares": "REAL",
    "short_interest_pct_float": "REAL",
    "days_to_cover": "REAL",
    "float_shares_source": "TEXT",
    "float_shares_asof_date": "TEXT",
    "float_shares_source_asof_date": "TEXT",
    "float_shares_staleness_days": "REAL",
    "float_shares_measurement_staleness_days": "REAL",
    "float_shares_proxy_flag": "REAL",
    "public_float_usd": "REAL",
    "public_float_price_date": "TEXT",
    "public_float_close_price": "REAL",
    "short_interest_pct_float_available_flag": "REAL",
    "short_interest_pct_score": "REAL",
    "short_interest_days_to_cover_score": "REAL",
    "short_interest_signal_basis": "TEXT",
    "short_interest_signal_max_possible_score": "REAL",
    "short_interest_signal_score": "REAL",
    "borrow_rate_current": "REAL",
    "borrow_fee_data_available_flag": "REAL",
    "shortable_data_available_flag": "REAL",
    "borrow_fee_stale_flag": "REAL",
    "shortable_stale_flag": "REAL",
    "borrow_fee_staleness_days": "REAL",
    "shortable_staleness_days": "REAL",
    "borrow_fee_history_count_30d": "REAL",
    "borrow_fee_history_count_90d": "REAL",
    "borrow_rate_30d_avg": "REAL",
    "borrow_rate_90d_avg": "REAL",
    "borrow_rate_spike_flag": "REAL",
    "borrow_rate_declining_flag": "REAL",
    "shortable_shares": "REAL",
    "shares_shortable_k": "REAL",
    "hard_to_borrow_flag": "REAL",
    "borrow_pressure_score": "REAL",
    "high_borrow_pressure_flag": "REAL",
    "elevated_borrow_pressure_flag": "REAL",
    "borrow_rate_high_flag": "REAL",
    "borrow_squeeze_setup_flag": "REAL",
    "borrow_distress_flag": "REAL",
    "institutional_ownership_delta_pct": "REAL",
    "institutional_accumulation_score": "REAL",
    "new_institutional_buyer_count": "REAL",
    "exiting_institutional_holder_count": "REAL",
    "net_institutional_buyer_count": "REAL",
    "insider_buy_count_90d": "REAL",
    "open_market_buy_count_90d": "REAL",
    "planned_10b5_1_buy_count": "REAL",
    "insider_buy_value_90d": "REAL",
    ...
    "biotech_calibration_cohort": "TEXT",
    "biotech_calibration_cohort_source": "TEXT",
    "biotech_calibration_cohort_reason": "TEXT",
    "biotech_calibration_cohort_version": "TEXT",
...
DAILY_FEATURES_OPTIONAL_COLUMNS = {
    ...
    "indication_success_area": "TEXT",
    "indication_success_probability": "REAL",
